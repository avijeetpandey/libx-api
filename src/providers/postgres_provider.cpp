...
PostgresProvider::PostgresProvider(const std::string &conninfo) : m_conn(conninfo) {}

void PostgresProvider::init() {
...
Book PostgresProvider::create_book(const std::string &title, const std::string &author, const std::string &isbn) {
  pqxx::work txn(m_conn);
...
std::vector<Book> PostgresProvider::list_books() {
  pqxx::work txn(m_conn);
...
std::optional<Book> PostgresProvider::get_book(int id) {
  pqxx::work txn(m_conn);
...
bool PostgresProvider::update_book(int id, const std::string &title, const std::string &author, const std::string &isbn) {
  pqxx::work txn(m_conn);
...
bool PostgresProvider::delete_book(int id) {
  pqxx::work txn(m_conn);
...
bool PostgresProvider::assign_book(int id, const std::string &assigned_to, const std::string &due_date) {
  pqxx::work txn(m_conn);
...
bool PostgresProvider::return_book(int id) {
  pqxx::work txn(m_conn);
